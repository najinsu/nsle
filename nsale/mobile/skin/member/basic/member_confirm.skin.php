...
// 150903 나진수 프로그램 수정 없이 ui 부분 수정
?>
...
<?php } ?>
    ...
    <form name="fmemberconfirm" id="fmemberconfirm" action="<?php echo $url ?>" onsubmit="return fmemberconfirm_submit(this);" method="post">
        ...
        <div class="btn_confirm">
            <a href="<?php echo G5_SHOP_URL ?>"  class="btn02">메인으로</a>
