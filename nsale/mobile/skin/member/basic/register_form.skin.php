...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" class="frm_input <?php echo $required ?> <?php echo $readonly ?>" <?php if($w=='u'){?> style="border:1px solid #ffffff !important; background: #ffffff !important;" readonly onfocus="this.blur();"<?php } ?> minlength="4" maxlength="20" <?php echo $required ?> <?php echo $readonly ?>>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="email" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input email required"  maxlength="100" style="margin-bottom:8px;">
                <br /><input type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>>&nbsp; E-mail 수신동의&nbsp;
 <br />* 입력한 연락처로 각종 이벤트 / 혜택 등의 정보를 안내받겠습니다.(거래정보 관련 내역은 동의와 관계없이 수신됩니다.)
        ...
        <tr>
            ...
            <td>
                <input type="tel" name="mb_hp" value="<?php echo $member['mb_hp'] ?>" onkeyup="this.value = this.value.replace(/\D/, '')" placeholder="( - 없이 숫자만 입력)" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="11" style="margin-bottom:8px;">
                <br /><input type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>>&nbsp; 휴대폰 수신 동의
        ...
        <tr>
            ...
            <td><!-- 150811 나진수 구매자 주소 우편번호 / 기본주소 박스 수정 못하게 / 주소검색 되게 작동 소스 추가  onclick ="win_zip()" readonly="readonly"-->
                ...
                <input type="text"readonly="readonly" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');return false;"  name="mb_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>" id="reg_mb_zip" <?php echo $config['cf_req_addr']?"required":""; ?> class="frm_input <?php echo $config['cf_req_addr']?"required":""; ?>" size="5" maxlength="6">
        ...
        // 150811 나진수 휴대폰 번호 10자 이상 스크립트 추가
            if (f.mb_hp.value.length > 0) {
                if (f.mb_hp.value.length < 10) {
                    alert("휴대폰 번호는 10~11자 이내로 입력하여 주십시오.");
                    f.mb_hp.focus();
                    return false;
                }
            }
