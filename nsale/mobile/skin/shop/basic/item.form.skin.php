...
<meta property="og:type" content="website" />
        ...
        <section id="sit_ov">
            <h2>상품간략정보 및 구매기능</h2>
            <strong id="sit_title"><?php echo preg_replace("<br/>", "/\'/", $it['it_name']); ?></strong>
            ...
            <div id="sit_sns">
                ...
                <?php echo get_sns_share_link('kakaotalk', $sns_url, $sns_title, G5_MSHOP_SKIN_URL . '/img/sns_kakao.png', G5_DATA_URL . '/item/' . $it['it_img1']); ?>
...
<?php if ($it['it_maker'] && $it['it_origin']) { ?>
                            <tr>
                                <th scope="row">제조사/원산지</th>
                                <td><?php echo $it['it_maker']; ?>/<?php echo $it['it_origin']; ?></td>
                            </tr>
<?php } ?>
...
<?php if ($it['it_buy_max_qty']) { ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $sc_method; ?>&nbsp;<?php if(($it['it_sc_type']==0)||($it['it_sc_type']==2)){ ?>(<?php echo number_format($it['it_sc_minimum']); ?>원 이상 구매 시 무료배송)<?php } ?></td><!-- 150812 나진수 if(($it['it_sc_type']==0)||($it['it_sc_type']==2)){  number_format($default['de_send_cost_limit']); 쇼핑몰 배송 조건 -->
                        </tr>
                    </tbody>
                </table>
            </div>
...
<!-- <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish">WISH</a>-->
    ...
    <div class="sanchor_bg"></div>
    <ul class="sanchor">
<?php // if ($default['de_baesong_content']) {      ?><!--<li id="dvr_on"><a href="#sit_dvr" >필독 정보</a></li>--><?php //}      ?>

        <li id="inf_on"><a href="#sit_inf"  >상품정보</a></li>

        <li id="qa_on"><a href="#sit_qa" >상품 FAQ</a></li>
        <?php if ($is_orderable) { ?>
            <li id="buy_now_btn"> <input type="submit" onclick="document.pressed = this.value;" value="구매하기" id="sit_btn_buy"></li>
<?php } ?>
    </ul>
