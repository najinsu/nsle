...
<article id="bo_v">
    ...
    <?php if($view['email'] || $view['hp']) { ?>
        ...
        <div id="bo_v_contact"><span><strong>작성자 </strong> <?php echo $view['name'] ?></span> <span><strong>휴대폰 </strong><?php echo $view['hp']; ?></span><span ><?php echo  date("y-m-d", strtotime($view['datetime'])); ?></span></div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
            ...
            <li><a href="<?php echo $list_href ?>" class="btn_b01" style="background: #555555; color:#ffffff;border: 0px; padding:7px 10px; ">목록</a></li>
    ...
    <section id="bo_v_atc">
        ...
        <!-- } 본문 내용 끝 -->
        <div class="item_name">상품명 : <?php echo strip_tags($view['qa_2']); ?></div>
    ...
    <section id="bo_v_rel">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td class="td_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($rel_list[$i]['qa_status'] ? '답변보기' : '답변대기'); ?></td>
