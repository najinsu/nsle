...
<div id="bo_list">
     ...
     <!-- 게시판 페이지 정보 및 버튼 시작 { -->
    <div class="bo_fx">
         <?php if ($write_href) { ?><div id="qa_write"><a href="<?php echo $write_href ?>" class="btn_b02">문의등록</a></div><?php } ?>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_title">
                    <a href="<?php echo $list[$i]['view_href']; ?>">
                        <div>[<?php echo $list[$i]['category']; ?>]</div>
                        
                        <?php echo $list[$i]['subject']; ?>
                       
                    </a>
                </div>
                   <div class="li_stat <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '답변완료' : '미답변'); ?></div>
