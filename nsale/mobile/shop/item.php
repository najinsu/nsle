...
?>
<style>
    /* 150828 나진수 페이지 로딩중 제목이 보여 item.form.skin.php 에 있는 소스를 이동시킴*/
    #container_title{display:none !important;height:0px !important; font-size: 0px !important;color:#ffffff !important;}
</style>
<?php 
// 분류 위치
// HOME > 1단계 > 2단계 ... > 6단계 분류
...
<div id="sit">
    ...
    <?php
    // 상품 상세정보
    include_once($skin_dir . '/item.info.skin.php');
    ?>
</div>
