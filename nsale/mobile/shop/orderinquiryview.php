...
//150815 나진수 영카트 5 패치 5.0.44  다른 회원 주문정보 조회가능 오류 수정 시작
if($is_member && !$is_admin)
    $sql .= " and mb_id = '{$member['mb_id']}' "; 
//150815 나진수 영카트 5 패치 5.0.44  다른 회원 주문정보 조회가능 오류 수정 끝
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            ?>
                ...
                <div class="li_prqty">
                    ...
                    <span class="prqty_stat li_prqty_sp"><span>상태 </span><?php if($opt['ct_status']=='배송'){ $opt['ct_status'] = '배송중'; } echo $opt['ct_status']; ?></span>
					 <!-- 151006 나진수 사용자 view 부분에서 배송이란 단어 혼돈으로 인한 배송중으로 변경 요청으로 변경 
                    /echo $opt['ct_status']/ ->  if($opt['ct_status']=='배송'){ $opt['ct_status'] = '배송중'; } 추가-->
                </div>
                <div class="li_total" >
        ...
        <div id="sod_sts_wrap">
            ...
            <div id="sod_sts_explan">
                <dl id="sod_fin_legend">
                    ...
                    <dt>준비</dt>
                    <dd>상품 준비 중입니다.</dd>
                    <dt>배송중</dt><!--151006 나진수 상품배송이라는 단어가 단어 혼돈으로 인한 배송중으로 변경 요청으로 변경 /상품배송/->배송중-->
                    <dd>상품 배송 중입니다.</dd>
                    <dt>완료</dt>
...
<?php
        ...
        else
        {
            ...
            if ($misu_price > 0) {
            echo '<dt class="sod_bsk_dvr">';
            echo '미결제액</dt>'.PHP_EOL;
            echo '<dd class="sod_bsk_dvr"><strong>'.display_price($misu_price).'</strong>';
            echo '</dd>';
            }
            ?>
    ...
    <section id="sod_fin_dvr">
            ...
            <div  class="odf_tbl">
                ...
                ?>
                <tr>
                    <td class="empty_table" colspan="4">아직 배송하지 않았거나 배송정보를 입력하지 못하였습니다.</td>
                </tr>
                <?php
                }
                ?>
