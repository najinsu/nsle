...
150828 나진수 현금영수증 퍼블릿 부분 추가 활성화 no_receipt->va_receipt
150831 나진수 입금 기한 날짜 설정 
-->
<?php  $deposit_after= date("Ymd ", G5_SERVER_TIME+(60*60*24*7)); ?>
<input type="hidden" name="acceptmethod" value="Vbank(<?php echo $deposit_after;?>):HPP(2):Card(0):va_receipt:cardpoint<?php echo $useescrow; ?>">
