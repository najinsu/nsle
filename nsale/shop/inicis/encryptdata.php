...
//$inipay->SetField("quotabase",  $inipay_quotabase);//할부기간 150815 나진수 영카트 5 패치 5.0.43  하면서 주석처리
$inipay->SetField("quotabase",  iconv_euckr($inipay_quotabase));// 할부기간 150815 나진수 영카트 5 패치 5.0.43 하면서 변경됨
/********************************
 * 4. 암호화 대상/값을 암호화함 *
 ********************************/
$inipay->startAction();
