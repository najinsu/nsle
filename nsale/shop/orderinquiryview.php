    ...
    <section id="sod_fin_list">
        ...
        <div class="tbl_head02 tbl_wrap">
            ...
            <tr>
                ...
                <td headers="th_itname" colspan="7"><a href="./item.php?it_id=<?php echo $row['it_id']; ?>"><?php echo preg_replace("<br/>", "/\'/", $row['it_name']); ?></a></td>
            </tr>
            <?php } ?>
            <tr>
                ...
                <td headers="th_itst" class="td_mngsmall"><?php if($opt['ct_status']=='배송'){ $opt['ct_status'] = '배송중'; } echo $opt['ct_status']; ?></td>
