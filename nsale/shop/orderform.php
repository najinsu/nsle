...
add_javascript('<script src="' . G5_JS_URL . '/shop.cart_time.js"></script>', 0);
...
require_once('./' . $default['de_pg_service'] . '/orderform.1.php');
    ...
    if(!$row_ct_selet_time['cnt']){
       ...
       alert('주문 요청 때까지 20분 이상 경과되어 주문 상품이 초기화 됐습니다.\n\n 주문하실 상품을 다시 확인해 주십시오.', G5_SHOP_URL);
    }
...
// $s_cart_id 로 현재 장바구니 자료 쿼리
                  ...
                  where a.od_id = '$s_cart_id'
                    ...
                    for ($i = 0; $row = mysql_fetch_array($result); $i++) {
                        ...
                        $it_name = '<b>' . preg_replace("<br/>", "/\'/", $row['it_name']) . '</b>';
                        ...
                        $order_new_price = $row['it_price'] + $row['io_price'];
                        ...
                        <tr>
                            ...
                            <td class="td_numbig"><?php echo number_format($order_new_price); ?></td>
                            <td class="td_numbig"><span class="total_price"><?php echo number_format($sell_price); ?></span></td>
                            <td class="td_dvr" style="width:80px;"><?php echo $ct_send_cost; ?></td>
                        </tr>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="od_hp" value="<?php echo $member['mb_hp']; ?>" id="od_hp" required class="frm_input required" placeholder="휴대전화(- 없이 숫자만 입력)" onkeyup="this.value = this.value.replace(/\D/, '')" maxlength="11"></td>
                        </tr>
                        <tr>
                        ...
                        <tr style="display:none">
                            ...
                            <td>
                                ...
                                <input type="text" name="od_zip" value="<?php echo $member['mb_zip1'] . $member['mb_zip2']; ?>" id="od_zip"  class="frm_input " size="5" maxlength="6">
                                ...
                                <input type="text" name="od_addr1" value="<?php echo $member['mb_addr1'] ?>" id="od_addr1"  class="frm_input frm_address " size="60">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!--150828 나진수 핸드폰 번호 입력란 최대 11개까지 변경 및 숫자만 입력가능하도록 변경 -->
                            <td><input type="text" name="od_b_hp" id="od_b_hp" placeholder="휴대전화(- 없이 숫자만 입력)" onkeyup="this.value = this.value.replace(/\D/, '')" value="<?php echo $row['mb_hp']; ?>" required class="frm_input required" maxlength="11"></td>
                        </tr>
                        <tr>
                            <th scope="row">주소</th>
                            <td id="sod_frm_addr"><!-- 150811 나진수 구매자 주소 우편번호 / 기본주소 박스 수정 못하게 / 주소검색 되게 작동 소스 추가  onclick ="win_zip()" readonly="readonly"-->
                                ...
                                <input type="text" name="od_b_zip"  readonly="readonly"  onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');
                                        return false;" id="od_b_zip" required class="frm_input required" size="10" maxlength="6">
                                ...
                                <input type="text" readonly="readonly"  name="od_b_addr1" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');
                                        return false;" id="od_b_addr1" required class="frm_input frm_address required" size="60">
...
<?php } ?>
        ...
        function forderform_check(f)
        {
            ...
            check_field(f.od_hp, "주문하시는 분 휴대폰를 입력하십시오.");
            ...
            check_field(f.od_b_hp, "받으시는 분 휴대폰를 입력하십시오.");
...
<?php if ($default['de_pg_service'] == 'inicis') { ?>
                ...
                f.recvtel.value = f.od_b_hp.value;
