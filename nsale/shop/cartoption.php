...
<div id="sit_sel_option">
    <ul id="sit_opt_added">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            $cart_opt_new_value=$it['it_price']+$row['io_price'];

            if($row['io_price'] < 0)
                $io_price = ' |&nbsp&nbsp'.number_format($cart_opt_new_value).'원';
            else
                $io_price = ' |&nbsp&nbsp'.number_format($cart_opt_new_value).'원';
        ...
        <li class="sit_<?php echo $cls; ?>_list">
            ...
            <div>
                ...
                <input type="text" style="width:32px;height:23px;" name="ct_qty[<?php echo $it['it_id']; ?>][]" value="<?php echo $row['ct_qty']; ?>" id="ct_qty_<?php echo $i; ?>" class="frm_input" size="5">
...
<div class="btn_confirm">
    ...
    <button type="button" id="mod_option_close" class="btn_cancel" style="padding:5px 0px 4px; width:84px; border:1px solid #555555; background:#555555; color:#ffffff;">닫기</button>
</div>
</form>
