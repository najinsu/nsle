...
{
    //로드벨런싱 대응 코드
    //로드밸런싱을 하면 REMOTE_ADDR가 사설IP로 들어간다.
    //로드밸런싱이면 사설IP -> 공인IP 변경 코드
    $remote_ip = "";
...
define('G5_HTTP_ADMIN_URL',  https_url(G5_ADMIN_URL, false));
define('G5_HTTPS_ADMIN_URL', https_url(G5_ADMIN_URL, true));
