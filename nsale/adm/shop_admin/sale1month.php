    ...
    <table>
        ...
        <tbody>
            ...
            for ($i = 0; $row = sql_fetch_array($result); $i++) {
                ...
                // 150901 나진수 취소 및 입금 금액 관련 수정 시작
                if ($row['od_receipt_price'] == 0) {
                    $row['od_cancel_price'] = 0;
                } else if ($row['od_cancel_price'] > 0) {
                    $row['od_cancel_price'] = $row['od_receipt_price'];
                     $row['orderprice']=$row['od_receipt_price'];
                }
                // 150901 나진수 취소 및 입금 금액 관련 수정 끝
