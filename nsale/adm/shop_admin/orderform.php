        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            <tr>
                ...
                <td rowspan="<?php echo $rowspan; ?>">
                    <a href="./itemform.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>"><?php echo $image; ?> <?php echo strip_tags(stripslashes($row['it_name'])); ?></a>
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_chk" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <!-- 150831 나진수 포인트 점수-> 입금기한으로 변경 -->
                <tr>
                    <th scope="row">입금기한 날짜</th>
                    <td><?php echo date('Y-m-d',strtotime(substr($od['od_time'],0,10).'+'.'7'.' days'));  ?>(주문 후 7일이내)</td>
                </tr>
                <tr>
        ...
        <section id="anc_sodr_paymo" class="compare_right">
            ...
            <div class="tbl_frm01">
                ...
                // 150824 나진수 주문자 전화번호 , 주소, 받는사람 전화번호 table 삭제
                ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="od_sms_ipgum_check" id="od_sms_ipgum_check" checked="checked">
...
function form_submit(f)
{
    ...
    <?php } ?>
        // 150828 나진수 관리자 페이지에서 휴대폰 취소시 PG사 연결 시작
        <?php if($od['od_settle_case'] == '휴대폰') { ?>
    if(status == "취소" || status == "반품" || status == "품절") {
        var $ct_chk = $("input[name^=ct_chk]");
        var chk_cnt = $ct_chk.size();
        ...
        if(chk_cnt == chked_cnt) {
            if(confirm("PG사의 휴대폰 결제를 함께 취소하시겠습니까?\n\n한번 취소한 결제는 다시 복구할 수 없습니다.")) {
                f.pg_cancel.value = 1;
                msg = "PG사의 휴대폰 결제 취소와 함께 ";
            } else {
                f.pg_cancel.value = 0;
                msg = "";
            }
    ...
    <?php } ?>
        // 150828 나진수 관리자 페이지에서 휴대폰 취소시 PG사 연결 끝
