...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" <?php echo $super_view?> id="th_skin">PC스킨</th>
    </tr>
    <tr>
        ...
        <th scope="col" <?php echo $super_view?> id="th_mskin"  >모바일스킨</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_skin" <?php echo $super_view?> class="td_numbig td_input" >
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_mskin" <?php echo $super_view?> class="td_numbig td_input">
