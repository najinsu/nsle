...
// 150901 나진수 카테고리 분류 검색 ca_id2부터 검색부분  $sql_search .= " and b.ca_id like '$sel_ca_id%' "; 에서 변경
if ($sel_ca_id != "") {
    $sql_search .= " and ( b.ca_id like '$sel_ca_id%' or  b.ca_id2 like '$sel_ca_id%' or  b.ca_id3 like '$sel_ca_id%')";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">입금완료</th><!-- 150831 나진수 주문대기-> 입금완료로 변경-->
        <th scope="col">가재고</th>
    ...
    <tbody>
    <?php
    // 150831 나진수 쇼핑, 주문 , 입금, 준비 상태에서 입금만 된것들만 카운팅 되게 변경됨
    ...
    <tr class="<?php echo $bg; ?>">
        <td>
            ...
            <a href="<?php echo $href; ?>"><?php echo get_it_image($row['it_id'], 50, 50); ?> <?php echo strip_tags($row['it_name']); ?></a>
        </td>
