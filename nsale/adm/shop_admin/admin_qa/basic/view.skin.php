...
add_stylesheet('<link rel="stylesheet" href="'.$admin_qa_skin_url.'/style.css">', 1);
?>
...
<article id="bo_v">
    ...
    // 질문글에서 답변이 있으면 답변 출력, 답변이 없고 관리자이면 답변등록폼 출력
        ...
        if($view['qa_status'] && $answer['qa_id'])
            include_once($admin_qa_skin_path.'/view.answer.skin.php');
        else
            include_once($admin_qa_skin_path.'/view.answerform.skin.php');
    }
