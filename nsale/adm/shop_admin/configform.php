...
<?php echo $frm_submit; ?>
<!-- 151008 나진수    최고관리자만 확인 사용가능하게 변경-->
<div <?php echo $super_view?>>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr class="pg_info_fld inicis_info_fld">
            ...
            <td>
                ...
                <input type="text" name="de_inicis_mid" value="<?php echo $default['de_inicis_mid']; ?>" id="de_inicis_mid" class="frm_input" size="10" maxlength="10" style="font:bold 15px Verdana;"> 영문소문자(숫자포함 가능)
            </td>
        </tr>
        <tr class="pg_info_fld inicis_info_fld">
    ...
    <section id="scf_sms_pre">
        ...
        <div class="local_desc01 local_desc">
            <dl>
                ...
                <dd>{이름} {회원아이디} {회사명}</dd>
                <dt>주문서작성</dt>
                <dd>{이름} {보낸분} {받는분} {가상계좌번호} {주문금액} {회사명}</dd>
                <dt>입금확인시</dt>
        ...
        <div id="scf_sms">
            <?php
            $scf_sms_title = array (1=>"회원가입시 고객님께 발송", "가상계좌 주문시 고객님께 발송", "주문시 관리자에게 발송", "입금확인시 고객님께 발송", "상품배송시 고객님께 발송", "비번 찾기시 고객님께 발송");
            for ($i=1; $i<=6; $i++) {
            ?>
