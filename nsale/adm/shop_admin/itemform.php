...
<section <?php echo $super_view?> id="anc_sitfrm_skin" >
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset" <?php echo $super_view?>>
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1">메인노출 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" <?php echo $super_view?> alt=""></label>
                <input <?php echo $super_view?> type="checkbox" name="it_type2" value="1" <?php echo ($it['it_type2'] ? "checked" : ""); ?> id="it_type2">
                <label <?php echo $super_view?> for="it_type2">추천 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""></label>
                <input <?php echo $super_view?> type="checkbox" name="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
                <label <?php echo $super_view?> for="it_type3">신상품 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""></label>
                <input <?php echo $super_view?>  type="checkbox" name="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                <label <?php echo $super_view?> for="it_type4">인기 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""></label>
                <input <?php echo $super_view?>  type="checkbox" name="it_type5" value="1" <?php echo ($it['it_type5'] ? "checked" : ""); ?> id="it_type5">
                <label <?php echo $super_view?> for="it_type5">할인 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
            </td>
            <td class="td_grpset" <?php echo $super_view?>>
        ...
        <tr>
            <th scope="row">모바일 상품설명<br />(비워두면 PC상품설명과 동일하게 보여집니다.</th>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset" >
                <input <?php echo $super_view?> type="checkbox" name="chk_ca_it_price" value="1" id="chk_ca_it_price">
                <label <?php echo $super_view?> for="chk_ca_it_price">분류적용</label>
                <input <?php echo $super_view?> type="checkbox" name="chk_all_it_price" value="1" id="chk_all_it_price">
                <label <?php echo $super_view?> for="chk_all_it_price">전체적용</label>
            </td>
        </tr>
        <tr >
            ...
            <td class="td_grpset" >
                <input <?php echo $super_view?> type="checkbox" name="chk_ca_it_cust_price" value="1" id="chk_ca_it_cust_price">
                <label <?php echo $super_view?> for="chk_ca_it_cust_price">분류적용</label>
                <input  <?php echo $super_view?>type="checkbox" name="chk_all_it_cust_price" value="1" id="chk_all_it_cust_price">
                <label <?php echo $super_view?> for="chk_all_it_cust_price">전체적용</label>
            </td>
        </tr>
        <tr>
...
<section id="anc_sitfrm_event" <?php echo $super_view?> class="srel">
...
<section id="anc_sitfrm_optional" <?php echo $super_view?>>
...
<section id="anc_sitfrm_extra" <?php echo $super_view?>>
    <h2>여분필드 설정</h2>
    <?php echo $pg_anchor ?>
