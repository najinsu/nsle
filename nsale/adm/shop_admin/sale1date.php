...
function print_line($save) {
    ...
    $save_tot_item_price = $save['receiptvbank'] + $save['receiptcard'] + $save['receipthp'];
    ...
    $save_real_price = $save_tot_item_price - $save['ordercancel'] - $save['od_send_cost'] - $save_commission;
    ?>
    <tr>
        ...
        <td class="td_num_prcie"><?php echo number_format($save_tot_item_price); ?></td>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <table>
        ...
        <tbody>
            ...
            $tot_item_price = $tot['receiptvbank'] + $tot['receiptcard'] + $tot['receipthp'];
