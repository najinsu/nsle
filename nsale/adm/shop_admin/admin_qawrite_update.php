...
if($w == 'a')
    $result_url = G5_ADMIN_URL.'/shop_admin/admin_qaview.php?qa_id='.$qa_id.$qstr;
else if($w == 'u' && $write['qa_type'])
    $result_url = G5_ADMIN_URL.'/shop_admin/admin_qaview.php?qa_id='.$write['qa_parent'].$qstr;
else
    $result_url = G5_ADMIN_URL.'/shop_admin/admin_qalist.php?'.preg_replace('/^&amp;/', '?', $qstr);
