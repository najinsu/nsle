...
/* 팝업 관리 창
header("Location: /nsale/index_sever_as_ing.php");
...
<title><?php echo preg_replace("[<br/>]", "", $g5_head_title); $g5_head_title; ?></title>
<?php
...
if ($is_member) { // 회원이라면 로그인 중이라는 메세지를 출력해준다.
    ...
    echo '<div id="hd_login_msg">'.$sr_admin_msg.$member['mb_id'].'님 로그인 중 ';
