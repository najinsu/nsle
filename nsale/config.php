...
//define('G5_YOUNGCART_VER', '5.0.42');
// 150815 나진수 영카트 5 패치 5.0.44 버전 올림
...
//이미지 서버 등록 경로
/*
$s_img_host = "54.64.7.8"; //접속할 서버의 ip나 도메인 
$s_img_port = "21"; //접속할 서버의 포트. 보통은 21을 사용할것이다.
$s_img_id = "root"; //접속할 서버의 id
$s_img_pw = "wow2014@969802192W"; //접속할 서버의 password 
$s_img_ftp_path = "/var/www/html/nsale/img/"; // 접속한 서버에 업로드되어 새로 생길 파일
global $s_img_host; 
global $s_img_port;
global $s_img_id;
global $s_img_pw;
global $s_img_ftp_path;
*/
...
define('G5_ALL_PERMISSION',  0777); // 디렉토리 생성시 퍼미션
