...
function sel_option_process(add_exec)
{
    ...
    if(add_exec) {
        ...
        add_sel_option(0, id, option, price, stock, it_price);
    }
}
...
function sel_supply_process($el, add_exec)
{
    ...
    if(add_exec) {
        ...
        add_sel_option(1, id, option, price, stock, it_price);
    }
}

// 선택된 옵션 출력
function add_sel_option(type, id, option, price, stock, it_price)
{
    ...
    var opt_prc;
    var io_price_new_value = it_price+parseInt(price);
    if(parseInt(price) >= 0)
        opt_prc = " |&nbsp&nbsp"+number_format(String(io_price_new_value))+"원";
    else
        opt_prc = " |&nbsp&nbsp"+number_format(String(io_price_new_value))+"원";
...
function price_calculate()
{
    ...
    $("#sit_tot_price").empty().html("<span>구매금액 :</span> "+number_format(String(total))+"원");
}
