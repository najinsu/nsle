    ...
    <form name="fpasswordlost" action="<?php echo $action_url ?>" onsubmit="return fpasswordlost_submit(this);" method="post" autocomplete="off">
        <fieldset id="info_fs">
            <p>
                ...
                로그인 후 마이페이지 - 정보수정에서 비밀번호를 변경하세요
            </p>
            ...
            <input type="text" name="mb_hp" id="mb_hp" onkeyup="this.value = this.value.replace(/\D/, '')"  placeholder="- 없이 숫자만 입력" required class="required frm_input" size="30">
        </fieldset>
        <div class="win_btn">
            <input type="submit" value="확인" class="btn_submit" style="width:56px;">
