...
<form name="fitem" method="post" action="<?php echo $action_url; ?>" onsubmit="return fitem_submit(this);">
    ...
    <div id="sit_ov_wrap">
        ...
        <div id="sit_pvi">
            <div id="sit_pvi_big">
                ...
                for ($i = 1; $i <= 10; $i++) {
                    ...
                    if ($img) {
                        // 썸네일
                        $thumb = get_it_thumbnail($it['it_img' . $i], 74, 74);
                        $thumbnails[] = $thumb;
                        $big_img_count++;
        ...
        <section id="sit_ov">
            ...
            <?php if ($is_orderable) { ?>
                <p id="sit_opt_info" style="background:#ffc;">
...
<?php if ($it['it_model']) { ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $sc_method; ?>&nbsp;<?php if(($it['it_sc_type']==0)||($it['it_sc_type']==2)){ ?>(<?php echo number_format($it['it_sc_minimum']); ?>원 이상 구매 시 무료배송)<?php } ?></td><!-- 150812 나진수 if(($it['it_sc_type']==0)||($it['it_sc_type']==2)){ number_format($default['de_send_cost_limit']); 쇼핑몰 배송 조건 수정 -->
                    </tr>
...
if ($supply_item) {
    ...
    <?php } ?>
                ...
                <!-- 총 구매액 -->
                <div style="margin-right:60px;" id="sit_tot_price"></div>
            <?php } ?>
