...
<?php if ($is_hp) { ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="qa_hp" value="<?php echo $ss_qa_hp ? $ss_qa_hp : $member['mb_hp']; ?>"  id="qa_hp" <?php echo $req_hp; ?> style="color:gray;" readonly="readonly" class="<?php echo $req_hp . ' '; ?>frm_input" size="30">
...
<?php } ?>
                            <div style="text-align: right;position: absolute; bottom:0px; right:0px; width:400px;">1장 당 5MB 이하의 이미지파일만 업로드 가능합니다.</div>
                        </td>
                    </tr>
