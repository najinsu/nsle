...
<article id="bo_v">
    ...
    <div id="bo_v_contact"><span><strong>작성자 </strong> <?php echo $view['name'] ?></span> <span><strong>휴대폰 </strong><?php echo $view['hp']; ?></span><span style="float:right;" ><?php echo  date("y-m-d", strtotime($view['datetime'])); ?></span></div>
